...
import com.gapps.core.presentation.designsystem.ArrowLeftIcon
...
fun RuniqueToolbar(
    ...
    var isDroopDownOpen by rememberSaveable {
    ...
    TopAppBar(
        ...
        actions = {
            if (menuItems.isNotEmpty()){
                Box {
                    DropdownMenu(
                        expanded = isDroopDownOpen,
                        onDismissRequest = { isDroopDownOpen = false },
                    ){
